        ...
        <div className="max-w-7xl mx-auto px-4 w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-dark-800 transition-colors text-slate-500 dark:text-dark-400"
            ...
            <button 
              ...
              className="px-5 py-2 rounded-xl bg-slate-100 dark:bg-dark-800 text-sm font-bold text-slate-700 dark:text-dark-200 hover:bg-primary-500 hover:text-white dark:hover:bg-primary-500 transition-all duration-300 shadow-sm"
            >
              Sign In
            </button>
          </div>
